...
public class ValidShootingZoneChecker {
    // Helper class for a coordinate pair
        ...
        // 2. Define the Fixed Vertices for Triangle 2 (The Fae/Human-Player side Zone)
        ...
        // ------------------------------------------------------------------------
        // CORE LOGIC: Cross-Product (Signed Area)
        // ------------------------------------------------------------------------

        private double crossProduct(Point P1, Point P2, Point P3) {
            // Formula: (P2.x - P1.x) * (P3.y - P1.y) - (P2.y - P1.y) * (P3.x - P1.x)
